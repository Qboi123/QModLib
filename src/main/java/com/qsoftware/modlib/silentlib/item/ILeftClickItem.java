...
import com.qsoftware.modlib.silentlib.network.internal.LeftClickItemPacket;
    ...
    final class EventHandler {
        ...
        private static void onLeftClickBlock(PlayerInteractEvent.LeftClickBlock event) {
            ...
            if (!stack.isEmpty() && stack.getItem() instanceof ILeftClickItem) {
                ...
                if (result.getType() == ActionResultType.SUCCESS) {
                    QModLibNetwork.channel.sendToServer(new LeftClickItemPacket(ClickType.BLOCK, event.getHand()));
                }
            }
        }
        ...
        private static void onLeftClickEmpty(PlayerInteractEvent.LeftClickEmpty event) {
            ...
            if (!stack.isEmpty() && stack.getItem() instanceof ILeftClickItem) {
                ...
                // Server-side call
                if (result.getType() == ActionResultType.SUCCESS) {
                    QModLibNetwork.channel.sendToServer(new LeftClickItemPacket(ClickType.EMPTY, event.getHand()));
                }
            }
        }
    }
